...
const projects: Project[] = [
  {
    ...
    description: 'Led a team of 5 to architect and build a full-stack IoT monitoring platform ingesting live sensor telemetry over MQTT, evaluating configurable thresholds, and streaming real-time alerts via SSE to a React dashboard. Owned the Threshold Management subsystem, API Facade, and DevOps end-to-end, with significant contributions across the Aggregation and Alerts subsystems.',
    highlights: [
